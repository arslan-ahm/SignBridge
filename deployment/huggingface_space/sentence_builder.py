...
(This is a bundled copy of app/sentence_builder.py for the Hugging Face
Space. On Spaces, set GEMINI_API_KEY as a Space "Secret" -- see
deployment/huggingface_space/README.md -- rather than an .env file.)
