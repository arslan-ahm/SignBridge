...
(This is a bundled copy of model/features.py for the Hugging Face Space,
which needs a self-contained app.py + its dependencies at this folder's
root -- see deployment/huggingface_space/README.md.)
"""
